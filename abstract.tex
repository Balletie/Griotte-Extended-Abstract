...
\textit{Griotte}. The core concept in the architecture of Griotte is
the usage of existing services which provide code review features
(\textit{e.g.} \textit{GitHub} or \textit{Gerrit}). See
\Cref{fig:diagram} for a simplified diagram of the architecture.
\begin{figure}[t]
